...
class LoginScreen(ScreenBase):
    ...
    def setup_screen(self) -> None:
        ...
        # Widgets
        self.title_label = tk.Label(self, text="LOGIN", bg='#000', fg="#fff", font=("Roboto", 34))
        self.email_label = tk.Label(self, text="Email", bg='#000', fg="#fff", font=("Roboto", 13))
        self.email_entry = tk.Entry(self)
        self.username_label = tk.Label(self, text="Username", bg='#000', fg="#fff", font=("Roboto", 13))
        self.username_entry = tk.Entry(self)
        self.password_label = tk.Label(self, text="Password", bg='#000', fg="#fff", font=("Roboto", 13))
        self.password_entry = tk.Entry(self, show="*")
        self.password2_label = tk.Label(self, text="Confirm Password", bg='#000', fg="#fff", font=("Roboto", 13))
        ...
        # Set Layout
        self.title_label.grid(row=0, column=0, columnspan=2, pady=8, padx=8)
        ...
        self.password2_label.grid(row=4, column=0)
        ...
        # Updatee Layout to reflect current panel (init LOGIN)
    ...
    def try_login(self) -> None:
        ...
        if self.cur_panel == Panel.REGISTER:
            # update screen
            self.update_screen(Panel.LOGIN)
            return
    ...
    def try_register(self) -> None:
        """"""
        # check we're on the right panel, update if necessary
        if self.cur_panel == Panel.LOGIN:
            # update screen
            self.update_screen(Panel.REGISTER)
            return
